# 2. Для класса Parrot цвет — важный параметр. Расширьте конструктор этого класса так, чтобы кроме имени и размера экземпляры класса принимали параметр color, цвет птицы.
...
# Подсказка
# Чтобы расширить возможности метода родительского класса, используйте функцию super().
# Чтобы создать экземпляр класса переменной, присвойте этой переменной имя необходимого класса и передайте в скобках необходимые параметры.
